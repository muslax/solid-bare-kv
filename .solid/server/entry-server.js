import { renderToStringAsync, isServer, createComponent, spread, delegateEvents, ssrElement, ssr, ssrHydrationKey, escape, useAssets, ssrAttribute, HydrationScript, NoHydration } from 'solid-js/web';
import { createContext, sharedConfig, createUniqueId, useContext, createRenderEffect, onCleanup, createSignal, getOwner, runWithOwner, createMemo, createComponent as createComponent$1, untrack, on, startTransition, resetErrorBoundaries, children, createRoot, Show, mergeProps, splitProps, createResource, ErrorBoundary as ErrorBoundary$1, createEffect, Suspense } from 'solid-js';
...
function Home() {
  ...
  })), escape(JSON.stringify(entries, null, 2)), escape(createComponent(Counter, {})));
}
